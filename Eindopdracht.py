...
De GUI voor het vinden van P-Loops.
"""
...
class PLoopGUI():
    ...
    # Opent het bestand aangegeven in het text vak van de GUI.
    # Roept een methode aan in CreatePlot om het bestand te verwerken tot data
    def _openFile(self):
    ...
    # Haalt de configuratie opties op uit de GUI, bij een error wordt de default waarde genomen.
    # Als de checkbox is aangevinkt, dan wordt de grafiek laten zien, anders wordt de data als platte text weergegeven.
    def _showData(self):
        try:
    ...
    # Setters voor text in de labels in de GUI
...
#        self.resultsLabel.config(anchor="w")
    ...
    # Setters voor text in de configuratie opties
    ...
    # Laat de grafiek (de .png) zien in een apart venster.
    def _showPlot(self):
